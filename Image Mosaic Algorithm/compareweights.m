function [MatchPointsInI1, MatchPointsInI2,weightmatrix1,weightmatrix2  ] = compareweights( weightmatrix1,weightmatrix2 )
...
for k=1:size(weightmatrix1,1)
   ...
   % if abs(weightmatrix1(k,2) - weightmatrix2(PixelPreference,2)) <50
